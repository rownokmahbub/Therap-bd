...
import {TbCurrencyTaka, TbIndentIncrease} from 'react-icons/tb'
...
export default function JobsDetails() {
  const skills = [
    ...
    {
      title:
        "Basic understanding about CMS such as Wordpress and designing websites using wordpress themes.",
    },
    {
    ...
    {
      title:
        "Proficient understanding of the importance of user-centered design.",
    },
    {
    ...
    {
      title:
        "Time management skills to work on multiple projects at once and with various deadlines.",
    },
    {
    ...
    <div className="container mx-auto md:h-screen max-w-6xl w-full">
      ...
      <div className="bg-slate-50 shadow-xl shadow-slate-50 dark:shadow-slate-800 border border-slate-200 dark:border-slate-600 dark:bg-slate-800  rounded-xl px-4 md:px-10 py-10 mt-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-3 my-6">
          <CgWorkAlt className="w-5 h-5 flex flex-shrink-0 "/>
          <span className="text-lg font-semibold">Experience :</span>
          <p className="text-center">2+ years of experience motivated freshers are encouraged to apply</p>
        </div>
        <div className="flex flex-col lg:flex-row items-center gap-3 my-6">
          <MdOutlineWorkOutline className="w-5 h-5 flex flex-shrink-0"/>
        ...
        <div className="flex flex-col  items-start gap-2 my-6">
          <div className="flex items-start md:items-center gap-3">
            <MdOutlineCastForEducation className="w-5 h-5 flex flex-shrink-0" />
            <p className="text-lg font-semibold">
          ...
          <div className="flex  items-start gap-3">
            ...
            <p>
              ...
              related field. The candidate must be proficient in the tools
              mentioned above. The candidate must have at least 2 years of
              experience in web design.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <BsPatchCheck className="w-5 h-5 flex flex-shrink-0" />A strong
            portfolio that displays creativity.
          </div>
        </div>
        <div className="flex flex-col  items-start gap-2 my-6">
          <div className="flex items-start md:items-center gap-3">
            <HiMiniClipboardDocumentList className="text-lg" />
            <p className="text-lg font-semibold">If Interested:</p>
          </div>

          <div className="flex  items-start gap-3">
            <BsPatchCheck className="w-5 h-5 flex flex-shrink-0" />
            <p>
              Please read through the job description and requirements. Only
        ...
        <div className="flex flex-col  items-start gap-2 my-6">
          <div className="flex items-start md:items-center gap-3">
            <TbCurrencyTaka className="w-5 h-5 flex flex-shrink-0"/>
        ...
        <div className="flex flex-col  items-start gap-2 my-6">
          <div className="flex items-start md:items-center gap-3">
            <TbIndentIncrease className="w-5 h-5 flex flex-shrink-0" />
            <p className="text-lg font-semibold">Other Benefits:</p>
          </div>
