...
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
  ...
  <Image className='max-w-4xl mt-4 w-full lg:h-[500px] rounded-3xl' loading='lazy' object-fit='contain' height={600} width={1000}  src="/hero2.png" alt="image" />
  </div>
...
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
  ...
  <Image className='max-w-4xl mt-4 w-full lg:h-[500px] rounded-3xl' loading='lazy' object-fit='contain' height={500} width={1000}  src="/hero3.png" alt="image" />
  </div>
...
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
  ...
  <Image className='max-w-4xl mt-4 w-full lg:h-[500px] rounded-3xl' loading='lazy' object-fit='contain' height={500} width={1000}  src="/hero1.png" alt="image" />
  </div>
