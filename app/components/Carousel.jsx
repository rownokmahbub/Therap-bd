...
export default class Carousel extends Component {
  ...
  <p className=' text-sm lg:text-lg  bg-yellow-100 dark:bg-yellow-800 px-4 py-1 my-5 w-fit rounded-xl border-l-8 border-yellow-300 text-yellow-600 dark:text-yellow-200'>With Therap BD</p>
  <h1 className='text-base lg:text-5xl capitalize font-bold mt-5'> Therap BD Employee with Raska Urzoshi Maa'm</h1>
...
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
  ...
  <Image className='max-w-xl mt-4 w-full xl:h-[500px] object-cover rounded-3xl' loading='lazy' object-fit='contain' height={600} width={1000}  src="/therap.png" alt="image" />
  </div>
  ...
  <h1 className='text-base lg:text-5xl capitalize font-bold mt-5'>Join the leading
software company</h1>
  <p className='text-xs lg:text-md text-slate-400 dark:text-slate-300 font-medium max-w-lg my-5'>Through a combination of lectures, readings, and discussions, students
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
  ...
  <h1 className='text-base lg:text-5xl capitalize font-bold mt-5'>We provide the best <br />
work environment</h1>
  <p className='text-xs lg:text-md text-slate-400 dark:text-slate-300 font-medium max-w-lg my-5'>Through a combination of lectures, readings, and discussions, students
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
...
<Image className='max-w-xs w-full h-full' loading='lazy' object-fit='contain' height={100} width={800}  src="/infoicon.png" alt="image" />
  ...
  <h1 className='text-base lg:text-5xl capitalize font-bold mt-5'>You don't just learn <br />
here, you grow</h1>
  <p className='text-xs lg:text-md text-slate-400 dark:text-slate-300 font-medium max-w-lg my-5'>Through a combination of lectures, readings, and discussions, students
will gain a solid foundation in educational psychology.</p>
 <Button className='shadow-xl ' color='primary' size='md' radius='sm'>
